...
func Test_StatementQueryValidator_ValidateAndGetStatementParams(t *testing.T) {
	t.Run("valid params", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&from_date=2026-01-01&to_date=2026-01-31", nil)
	...
	t.Run("missing from_date", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&to_date=2026-01-31", nil)
		v := NewStatementQueryValidator()
	...
	t.Run("missing to_date", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&from_date=2026-01-01", nil)
		v := NewStatementQueryValidator()
		_ = v.ValidateAndGetStatementParams(req)
		assert.True(t, v.HasErrors())
	...
	t.Run("invalid from_date format", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&from_date=2026-13-01&to_date=2026-01-31", nil)
		v := NewStatementQueryValidator()
		_ = v.ValidateAndGetStatementParams(req)
		assert.True(t, v.HasErrors())
	...
	t.Run("invalid to_date format", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&from_date=2026-01-01&to_date=not-a-date", nil)
		v := NewStatementQueryValidator()
		_ = v.ValidateAndGetStatementParams(req)
		assert.True(t, v.HasErrors())
	...
	t.Run("from_date after to_date", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=XLM&from_date=2026-01-31&to_date=2026-01-01", nil)
		v := NewStatementQueryValidator()
		_ = v.ValidateAndGetStatementParams(req)
		assert.True(t, v.HasErrors())
	...
	t.Run("from_date equals to_date is valid", func(t *testing.T) {
		req, _ := http.NewRequest(http.MethodGet, "/statements?asset_code=USD&from_date=2026-01-15&to_date=2026-01-15", nil)
		v := NewStatementQueryValidator()
		params := v.ValidateAndGetStatementParams(req)
		assert.False(t, v.HasErrors())
